...
static int sequence_ext (mpeg2dec_t * mpeg2dec)
{
    ...
    fprintf(stdout, "SEQUENCE FRAME PERIOD: %d - ", sequence->frame_period);
    fprintf(stdout, "CADENCE IPS: %d\n", 27000000 / sequence->frame_period);
    fprintf(stdout, "SEQUENCE PROGRESSIVE: %d\n", sequence->flags &
...
static int picture_coding_ext (mpeg2dec_t * mpeg2dec)
{
    ...
    fprintf(stdout, "FRAME PROGRESSIVE: %d\n", (picture->flags &
    PIC_FLAG_PROGRESSIVE_FRAME) != 0);
    fprintf(stdout, "FRAME TOP FIELD FIRST: %d\n", (picture->flags &
    PIC_FLAG_TOP_FIELD_FIRST) != 0);
    fprintf(stdout, "FRAME REPEAT FIRST FIELD: %d\n", (picture->flags &
    PIC_FLAG_REPEAT_FIRST_FIELD) != 0);
    fprintf(stdout, "\n");
